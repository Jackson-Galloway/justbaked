...
int main(int argc, char ** argv)
{
  ...
  auto posewithcovariance_posewithcovariancestamped_pub =
    node->create_publisher<geometry_msgs::msg::PoseWithCovarianceStamped>("posewithcovariance_posewithcovariancestamped", 1);
  geometry_msgs::msg::PoseWithCovarianceStamped posewithcovariance_posewithcovariancestamped_msg;
  ros_gz_bridge::testing::createTestMsg(posewithcovariance_posewithcovariancestamped_msg);
  ...
  auto materialcolor_materialcolor_pub =
    node->create_publisher<ros_gz_interfaces::msg::MaterialColor>("materialcolor_materialcolor", 1);
  ros_gz_interfaces::msg::MaterialColor materialcolor_materialcolor_msg;
  ros_gz_bridge::testing::createTestMsg(materialcolor_materialcolor_msg);
  ...
  while (rclcpp::ok()) {
    ...
    posewithcovariance_posewithcovariancestamped_pub->publish(posewithcovariance_posewithcovariancestamped_msg);
    ...
    materialcolor_materialcolor_pub->publish(materialcolor_materialcolor_msg);
