...
#define NODE_MAIN_LOGGER_NAME "gzserver"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgzserver_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ros_gz_sim::GzServer>";
