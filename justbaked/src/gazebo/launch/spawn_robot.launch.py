...
def generate_launch_description():
    ...
    pkg_urdf_path = get_package_share_directory('robdesc')
    pkg_gazebo_path = get_package_share_directory('gazebo')
    ...
    world_arg = DeclareLaunchArgument(
        'world', default_value='firearena.sdf',
    ...
    spawn_urdf_node = Node(
        ...
        arguments=[
            ...
            "-x", "0.0", "-y", "-1.0", "-z", "0.0", "-Y", "0.0"  # Initial spawn position
        ],
        output="screen",
        parameters=[
            {'use_sim_time': True},
