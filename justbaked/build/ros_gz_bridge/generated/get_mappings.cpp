...
get_gz_to_ros_mapping(const std::string & gz_type_name, std::string & ros_type_name)
{
  ...
  if (gz_type_name == "gz.msgs.PoseWithCovariance" || gz_type_name == "ignition.msgs.PoseWithCovariance")
  {
    ros_type_name = "geometry_msgs/msg/PoseWithCovarianceStamped";
    return true;
  }
  ...
  if (gz_type_name == "gz.msgs.MaterialColor" || gz_type_name == "ignition.msgs.MaterialColor")
  {
...
get_ros_to_gz_mapping(const std::string & ros_type_name, std::string & gz_type_name)
{
  ...
  if (ros_type_name == "geometry_msgs/msg/PoseWithCovarianceStamped")
  {
    gz_type_name = "gz.msgs.PoseWithCovariance";
    return true;
  }
  ...
  if (ros_type_name == "ros_gz_interfaces/msg/MaterialColor")
  {
...
get_all_message_mappings_ros_to_gz()
{
  static std::multimap<std::string, std::string> mappings = {
    ...
    {
      "ros_gz_interfaces/msg/MaterialColor",  // ROS 2
      "gz.msgs.MaterialColor", // Gazebo
    },
    {
      "ros_gz_interfaces/msg/MaterialColor",  // ROS 2
      "ignition.msgs.MaterialColor", // Gazebo
    },
    {
