...
int main(int /*argc*/, char **/*argv*/)
{
  ...
  auto posewithcovariance_posewithcovariancestamped_pub =
    node.Advertise<gz::msgs::PoseWithCovariance>("posewithcovariance_posewithcovariancestamped");
  gz::msgs::PoseWithCovariance posewithcovariance_posewithcovariancestamped_msg;
  ...
  auto materialcolor_materialcolor_pub =
    node.Advertise<gz::msgs::MaterialColor>("materialcolor_materialcolor");
  gz::msgs::MaterialColor materialcolor_materialcolor_msg;
